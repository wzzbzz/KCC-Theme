...
<div class="main_my_pro p-3">
    ...
    <?php
        ...
        <?php
            $generalToCheck = [
                'Animal-services', 'Canvassing', 'Communications', 
                'Collection/Entry', 'Disaster-child-care', 'Warehousing', 
                'Logistics', 'Reunification', 'Traffic-Management', 
                'Interpretation/Translation', 'Transportation', 
                'Coordination', 'Shelter-Services', 'General_N/A'
            ];
        ...
        <?php endif; ?>
        <?php
            $volunteerToCheck = ['Feeding', 'Greeters/Receptionists', 'Security', 'Runner',
            'Interviewer','Resource-coordinator','Volunteer-manager','Volunteer_N/A','Trainer'];
