        ...
        <div class="blog-card">
            <div class="image">
                ...
                <div class="blog-dropdown">
                    <div class="dropdown">
                        ...
                        <a class="dropdown-item" href="javascript:void(0)"   onclick ='editBlog("<?=$value->ID; ?>","<?=$value->post_content; ?>","<?php echo $blogImg ?>","<?php echo $value->post_title; ?>");'>Edit Post</a>
                        <a href="javascript:void(0)" class="dropdown-item" onclick ='deleteBlog("<?php echo $value->ID?>")'>Delete</a>
            ...
            <div class="card-title">
                <div class="d-flex justify-content-between w-100">
                    <div class="title">
                         <a href="<?php echo get_permalink( $value->ID )?>"><h6><?php echo $value->post_title; ?> </h6></a>
                    </div>
                    <div class="blog-date">
                ...
                <div class="blog-description">
                  <a href="<?php echo get_permalink( $value->ID )?>">   <p> <?php echo  wp_trim_words($value->post_content,15);?></p> </a>
                </div>
            </div>
        </div>
    </div>
