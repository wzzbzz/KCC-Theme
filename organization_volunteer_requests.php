...
/* Template Name: Organization Volunteer Requests*/
    ...
    <div class="row justify-content-end mt-3">
            ...
            <div class="col-xl-8 col-lg-7 col-md-8 col-12">
                ...
                <div class="notification_Sec_main">
                    ...
                    <p>
                        ...
                        This form is for registered organizations delivering services free of charge to disaster affected communities. Please be prepared to safely and effectively track and manage the volunteers that you are requesting.
        ...
        <div class="col-xl-11 col-lg-11 col-md-11 col-10 mb-4">
            ...
            <div class="btn_list_blog ">
               ...
               <!-- <a href="<?//php echo site_url('create-organization-report-form'); ?>" class="mr-4">
                         ...
                         global $wpdb;
                          ...
                          if(isset($_GET['submit']))

                            {
                                ...
                                $sql = "SELECT * FROM wp_posts WHERE post_title LIKE '%$Q_name%' AND post_date LIKE '%$Q_date%' AND post_type ='volunteer_request' ";
                            ...
                            foreach($reportData as $report){
                                 ...
                                 ?>
                                   ...
                                   <tr class="bg-color">
                                        ...
                                        <!--  <td><?//php echo get_post_meta($rid,'group_id',true)?></td> -->
