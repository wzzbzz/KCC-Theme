 <?php 
   ...
   /* Template Name: create organization report form  */
                                    ...
                                    <div class="all-form">
                                        ...
                                        <form method = "POST" action ="" class="row mediadoc_form" enctype="multipart/form-data">
                                         ...
                                         <input type ="hidden" name ="group_id"  id="group_id"  value ="<?php echo $gid;?>">
                                            ...
                                            <input type="hidden" name="create_organizationVolunteerReq" value="create_organizationVolunteerReq"/>
                                                      ...
                                                      <?php
                                                        ...
                                                        ?>
                                                         ...
                                                         <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control na_ev"  name="post_title" placeholder="Enter here" value="<?php echo get_post_meta($rf_id,'post_title',true)?>">

                                                            </div>

                                                             <div class ="marker" id ="na_ev_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control na_or"  name="vol_org" placeholder="Enter here" value="<?php echo get_post_meta($rf_id,'vol_org',true)?>">
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control con_pe"  name="vol_person" placeholder="Enter Name" value="<?php echo $userInfo->first_name;  ?> <?php echo $userInfo->last_name;  ?>" readonly>

                                                            </div>

                                                             <div class ="marker" id ="con_pe_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control ti_org"  name="vol_title" placeholder="Enter title" value="<?php echo get_post_meta($rf_id,'vol_title',true)?>">

                                                            </div>

                                                             <div class ="marker" id ="ti_org_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" class="form-control ev_em" name="vol_email" placeholder="Enter email" value="<?php echo $userInfo->user_email; ?>" readonly >

                                                            </div>

                                                             <div class ="marker" id ="ev_em_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control ev_ph" id="phone" name="vol_phone" placeholder="Enter phone no." value="<?php echo get_post_meta($rf_id,'vol_phone',true)?>">

                                                            </div>

                                                             <div class ="marker" id ="ev_ph_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control ev_add"  name="vol_address" placeholder="Enter Address" value="<?php echo get_post_meta($rf_id,'vol_address',true)?>">

                                                            </div>

                                                             <div class ="marker" id ="ev_add_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control ev_zi" onKeyPress="if(this.value.length==6) return false;" min="0"  name="vol_zipcode2" placeholder="Enter " value="<?php echo $userInfo->code;?>" readonly>

                                                            </div>

                                                             <div class ="marker" id ="ev_zi_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                               ...
                                                               <input type ="text" class ="form-control ev_co" name ="country" value="<?php echo $userInfo->country;?>" readonly>

                                                            </div>

                                                             <div class ="marker" id ="ev_co_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                               ...
                                                               <input type ="text" class ="form-control ev_st" name ="state" value="<?php echo $userInfo->state;?>" readonly>   

                                                            </div>

                                                             <div class ="marker" id ="ev_st_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                               ...
                                                               <input type ="text" class ="form-control ev_ci" name ="city" value="<?php echo $userInfo->city;?>" readonly>

                                                            </div>

                                                             <div class ="marker" id ="ev_ci_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control ev_we" name="vol_website" placeholder="Enter Website  Url " value="<?php echo get_post_meta($rf_id,'vol_website',true)?>">

                                                            </div>

                                                             <div class ="marker" id ="ev_we_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control ev_mi"  name="vol_mission" placeholder="Enter Mission " value="<?php echo get_post_meta($rf_id,'vol_mission',true)?>">

                                                            </div>

                                                             <div class ="marker" id ="ev_mi_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control org_na" name="volunteer_org" placeholder="Enter here" value="<?php echo get_post_meta($rf_id,'volunteer_org',true)?>">

                                                            </div>

                                                             <div class ="marker" id ="org_na_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control or_co"  name="volunteer_contact_person" placeholder="Enter here " value="<?php echo get_post_meta($rf_id,'volunteer_contact_person',true)?>">

                                                            </div>

                                                             <div class ="marker" id ="or_co_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" class="form-control or_em" name="volunteer_pEmail" placeholder="Enter here " value="<?php echo get_post_meta($rf_id,'volunteer_pEmail',true)?>">

                                                            </div>

                                                             <div class ="marker" id ="or_em_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"  name="volnteer_pTitle" placeholder="Enter here" value="<?php echo get_post_meta($rf_id,'volnteer_pTitle',true)?>">
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control or_ph" id="phone" name="volnteer_pPhone" placeholder="Enter here" value="<?php echo get_post_meta($rf_id,'volnteer_pPhone',true)?>">

                                                            </div>

                                                             <div class ="marker" id ="or_ph_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"  name="point_org" placeholder="Enter here" value="<?php echo get_post_meta($rf_id,'point_org',true)?>">
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"  name="point_contact" placeholder="Enter here " value="<?php echo get_post_meta($rf_id,'point_contact',true)?>">
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"  name="point_title" placeholder="Enter title " value="<?php echo get_post_meta($rf_id,'point_title',true)?>">
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" class="form-control "  name="point_email" placeholder="Enter email" value="<?php echo get_post_meta($rf_id,'point_email',true)?>">
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control or_p" id="phone" name="point_phone" placeholder="Enter " value="<?php echo get_post_meta($rf_id,'point_phone',true)?>">

                                                            </div>

                                                             <div class ="marker" id ="or_p_error"></div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                               ...
                                                               <!--  <textarea class="form-control" name="" placeholder="Enter here"></textarea> -->
                                                                 ...
                                                                 <input type="text" class="form-control vol_sc"  name="vol_scope" placeholder="Enter here" value="<?php echo get_post_meta($rf_id,'vol_scope',true)?>"> 

                                                            </div>

                                                             <div class ="marker" id ="vol_sc_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" class="form-control vol_st"  name="vol_start_date" placeholder="Enter here" value="<?php echo get_post_meta($rf_id,'vol_start_date',true)?>">

                                                            </div>

                                                             <div class ="marker" id ="vol_st_error"></div>
                                                          ...
                                                          <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" class="form-control vol_sh"  name="vol_shift_start_date" placeholder="Enter here" value="<?php echo get_post_meta($rf_id,'vol_shift_start_date',true)?>">

                                                            </div>

                                                             <div class ="marker" id ="vol_sh_error"></div>
                                                          ...
                                                          <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" class="form-control vol_en"  name="vol_shift_end_date" placeholder="Enter here" value="<?php echo get_post_meta($rf_id,'vol_shift_end_date',true)?>">

                                                            </div>

                                                             <div class ="marker" id ="vol_en_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                             ...
                                                             <div class ="marker" id ="vol_se_error"></div>
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                             ...
                                                             <div class ="marker" id ="vol_ci_error"></div>
                                                         ...
                                                         <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control vol_ne"  name="area_neighbour" placeholder="Enter here" value="<?php echo get_post_meta($rf_id,'area_neighbour',true)?>">

                                                            </div>

                                                             <div class ="marker" id ="vol_ne_error"></div>
                                                         ...
                                                         <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control vol_zi" onKeyPress="if(this.value.length==6) return false;" min="0" name="area_zip" placeholder="Enter here" value="<?php echo get_post_meta($rf_id,'area_zip',true)?>">

                                                            </div>

                                                             <div class ="marker" id ="vol_zi_error"></div>
                                                         ...
                                                         <div class="col-lg-4 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control vol_oth" id="area_other" name="area_other" placeholder="Enter here" value="<?php echo get_post_meta($rf_id,'area_other',true)?>">
                                                        ...
                                                        <div class="col-lg-4 mb-3">
                                                         ...
                                                         <div class="col-lg-12 mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control dis_sk"  name="vol_disq" placeholder="Enter here" value="<?php echo get_post_meta($rf_id,'vol_disq',true)?>">

                                                            </div>

                                                             <div class ="marker" id ="dis_sk_error"></div>
                                                                ...
                                                                <div class="col-12 col-lg-3 mb-3">
                                                                    ...
                                                                    <div class="form-check d-flex align-items-center">
                                                                        ...
                                                                        <label class="form-check-label">
                                                                            ...
                                                                            <input type="radio" <?php echo (get_post_meta($rf_id,'vol_skills',true)=="Emergency Service")?"CHECKED='CHECKED'":""?> class="form-check-input sk_vo" value="Emergency Service" name="vol_skills">Emergency Service

                                                                        </label>

                                                                    </div>

                                                                     <div class ="marker" id ="sk_vo_error"></div>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12 d-flex justify-content-center">
                                                         ...
                                                         <button class="btn btn-outline-primary"  value="save" name="save" title="Next">Submit</button>
...
<script type="text/javascript">
    ...
    $("#step-btn-1").click(function(){
         ...
         var tiOrg = $('.ti_org').val();

         var evPh = $('.ev_ph').val();

         var evAdd = $('.ev_add').val();
        ...
        if(evPh ==''){
            ...
            $("#ev_ph_error").text("Please enter your phone.");
        ...
        if(evAdd ==''){
            ...
            $("#ev_add_error").text("Please enter your address.");
         ...
         if(tiOrg ==''){
            ...
            $("#ti_org_error").text("Please enter your title.");
         ...
         if(naOr ==''){
            ...
            $("#na_or_error").text("Please enter organization name.");
        ...
        if(naEv ==''){
            ...
            $("#na_ev_error").text("Please enter event name .");
    ...
    $("#step-btn-3").click(function(){
        ...
        var volSc = $('.vol_sc').val();

        var volSe = $('.vol_se').val();

        var seSt = $('.se_st').val();

        var volCi = $('.vol_ci').val();
        ...
        if(volSc ==''){
            ...
            $("#vol_sc_error").text("Please enter your scope.");
         ...
         if(volSe ==''){
            ...
            $("#vol_se_error").text("Please enter your country.");
        ...
        if(seSt ==''){
            ...
            $("#se_st_error").text("Please enter your state.");
        ...
        if(volCi ==''){
            ...
            $("#vol_ci_error").text("Please enter your city.");
    ...
    $("#step-btn-4").click(function(){
        ...
        var publishFrom = document.getElementsByName('vol_skills');

                for (let z of publishFrom) {
                 ...
                 if(z.checked) {
                    ...
                    $("#sk_vo_error").text("Select any option.");
