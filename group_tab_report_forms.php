<?php 
/*Template Name: Group Tab Report and Forms*/
            ...
            <div class="col-xl-11 col-lg-11 col-md-11 col-10 mt-3 mb-4 pb-4">
               <div class="memebr_tab_pills reports-forms">
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="pills-annoucements-tab" data-toggle="pill" href="#pills-annoucements" role="tab" aria-controls="pills-annoucements" aria-selected="false">Announcements</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content resources-inc remove-space" id="pills-tabContent">
                        <!--<div class="tab-pane fade " id="pills-feeds" role="tabpanel" aria-labelledby="pills-feeds-tab">
                            <div class="tab-pane fade show active" id="pills-feeds" role="tabpanel" aria-labelledby="pills-feeds-tab">
                                <?//php include('feed_inc.php');?>        
                            </div>
                        </div>-->
