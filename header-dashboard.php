...
<head>
    ...
    <!-- link includes from user-dashboard.php -->
...
<body class="main_all_bg_Sec dashboard">

    <div class="main_side_bar_left abhi">
        <?php include('sidebar_menu.php'); ?>
    </div>

    <div id="main-container" class="col-xl-12 ">
        <div id="content-area" class="row justify-content-end mt-3">

            <div id="topnav" class="col-xl-11 col-lg-11 col-md-11 col-10 d-flex align-items-center flex-wrap">
                <?php include('user_topbar.php') ?>
            </div>

            <div id="flash-message" class="col-xl-11 col-lg-11 col-md-11 col-10  my-4"><? do_action('flash_msg'); ?></div>