    ...
    <div class="login_nav">
      <nav class="navbar  justify-content-between">
        ...
        <form class="form-inline">
          <button class="btn btn_account active"><a href="<?php echo get_site_url(); ?>/forgot-password/" color="#fff">Back</a></button>
        </form>
      </nav>
    </div>
                      ...
                      <form method = "POST" action ="" class="row mediadoc_form" enctype="multipart/form-data">   
                        <input type="hidden" name="email" value="<?php echo $_GET['email']; ?>">
                          ...
                          <div class="verification-code--inputs"> 
                            ...
                            <p class="w3-center mb-0"><button class="w3-btn w3-green w3-round submit_varification22" style="height:60px;background-color:#F96703;color:#fff;margin-top:20px;border-radius: 10px;width:100%;" name="submit33">Submit</button></p>   
                          </div>
                      </form>
                   <div class="resend_code mt-0">
                           ...
                           <p>Didn’t Receive the code? 
                            <button style="background-color:transparent; color:#F96703; margin-left:-25px;">Resend</button> 
                          </p>
                        </form>
                      </div>
