                    ...
                    <div class="d-flex align-items-center justify-content-between grp_box">
                        <div class="g_group_box_new">
                            <ul class="nav nav-pills mb-3 linked_blog" id="pills-tab" role="tablist">
                                ...
                                <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">All Requests </a>
                                </li>
                                <li class="nav-item group_btn">
                ...
                <div class="groups_tabs">
                    <div class="tab-content" id="pills-tabContent">
                         <div class="tab-pane fade active show" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">                        
                                ...
                                <?php
                                $result = $wpdb->get_results("SELECT * FROM group_invite WHERE `group_id` = $groupId ");
                                if(!empty($result))
                                        ...
                                        <div class="custom-card d-flex align-items-center justify-content-center">
                                            <div class="close-group">
                                                ...
                                                <div class="text-center mt-3">
                                                    ...
                                                    <p><small>Requested on <?php echo get_the_time('m-d-Y', $value->invited_to) ?></small></p>
                                                </div>
                                                <!--<div class="col-md-12 text-center requests-btn mt-2">
