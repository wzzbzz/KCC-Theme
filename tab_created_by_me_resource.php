<?php
/* Template Name: Tab Created By Me Resource*/ 
                    ...
                    <div class="linked_blog">
                        <ul class="nav nav-pills justify-content-center" role="tablist">
                            ...
                            <li class="nav-item active">
                                <a class="nav-link active" href="<?= site_url();?>/resources-created-by-me/">
                                    <i class="now-ui-icons shopping_cart-simple"></i> Created By Me
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?= site_url();?>/media-documents/">
                    ...
                    <div class="tab-content w-100">
                            <div class="col-xl-12 d-flex align-items-center justify-content-between flex-wrap px-0 mb-0">
                                ...
                                <div class="btn_list_blog btn_short_list my-lg-4 mr-lg-4">
                                    <button class="btn_short_list" type="button" data-toggle="modal" data-target="#byMeModal"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/group_icon.png" class="img-fluid mr-2">Sort</button>
                                </div>
                            </div>
                                                ...
                                                if(isset($_GET['submit']))
                                                    {
                                                        ...
                                                        $Q_name  =  $_GET['q_name'];
                                                        $Q_date  =  $_GET['q_date'];
                                                        $sql = "SELECT * FROM wp_posts WHERE post_title LIKE '%$Q_name%' AND post_date LIKE '%$Q_date%' AND post_type ='resources' AND post_author = $current_user_id";
            ...
            <div class="modal-dialog mr-short-by modal-xl modal-dialog-centered create_tickit modal-dialog-scrollable custom-modal-ap" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id ="allResForm"  method="get" action="" class="p-0 m-0">
                            <div class="row m-0">
