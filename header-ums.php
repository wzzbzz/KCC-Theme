...
\  
    ...
    <style>
        ...
        .res .btn { font-family: 'Poppins'; font-size: 14px; font-weight: 500;}
    </style>
    ...
    <div class="main_side_bar_left">
        <div class="main_menu_sec">
            ...
            <div class="center_logo_sec">
                ...
                <div class="main_menu_Sec">
                    <a href="<?php echo get_site_url(); ?>/dashboard-my-profile/">
                        <div class="menu_icon ">
                ...
                <div class="main_menu_Sec">
                    <a href="<?php echo get_site_url(); ?>/knowledge-center/">
                        <div class="menu_icon ">
                ...
                <div class="main_menu_Sec">
                    <a href="<?php echo get_site_url(); ?>/my-resources">
                        <div class="menu_icon ">
            ...
            <div class="bottom_logo_sec">
                ...
                <div class="main_menu_Sec">
                    <a href="<?php echo get_site_url(); ?>/user-profile-setting/">
                        <div class="menu_icon ">
