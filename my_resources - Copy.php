                        ...
                        <ul class="nav nav-pills justify-content-center" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#media-documents" role="tab">
                                    <i class="now-ui-icons shopping_shop"></i> Media & Documents
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-content w-100">
                        <div class="tab-pane active " id="all" role="tabpanel">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="table-btn">
                                    <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/group_icon.png" class="img-fluid mr-2">Short</button>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="created-by-me" role="tabpanel">
                            <div class="col-xl-12 d-flex align-items-center justify-content-between flex-wrap px-0 mb-0">
                                ...
                                <div class="btn_list_blog btn_short_list my-lg-4 mr-lg-4">
                                    <button class="btn_short_list" type="button" data-toggle="modal" data-target="#myModal"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/group_icon.png" class="img-fluid mr-2">Short</button>
                                </div>
                            </div>
                             <div class="global-table">
                                <div class="table-responsive">
                            ...
                            <div class="col-lg-12 col-12 modal-btn-ap">
                                <div class="d-flex justify-content-between align-items-center w-100">
                                    <div class="left-btn w-100">
                                        <button class="btn btn-outline-primary close" title="Cancal" data-dismiss="modal">Cancal</button>
                                    </div>
                                    <div class="mx-2"></div>
          ...
          $.ajax({
            ...
            $(".downloadF").click(function () {
                ...
                let img1 = $(this).data('img');
                 window.open("<?php echo site_url('my-resources')?>/?download_file="+img1, '_blank');
