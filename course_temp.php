    ...
    <div class="col-xl-12 ">
        ...
        <div class="row justify-content-end mt-3">
           ...
           <div class="col-xl-11 col-lg-11 col-md-11 col-10 mt-3">
                ...
                <div class="main_box_center_tickit  col-xl-12 my_pro_head">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    <div class="w-50 text-center">
                                        ...
                                        <h2 class="course-list">Courses List</h2>

                                        <p>We partner with NGOs, leading agencies, and experts in disaster response humanitarian aid to

                                            make the best one stop disaster training and coordination portal available to you anywhere,

                                            anytime, for FREE. Select the training you need, get credentialed and connect with other

                                            disaster responders all in one place
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-xl-5">
                                        ...
                                        <h2 class="elementor-heading-title1">Collaborative Disaster Volunteer Credential</h2>

                                        <p>

                                            Lorem Ipsum is simply dummy text of the printing and type setting industry.Lorem Ipsum is simply dummy text of the printing and type setting industry. Lorem Ipsum is simply dummy text of the printing and type setting industry.Lorem Ipsum is simply dummy text of the printing and type setting industry.

                                        </p>

                                        <a href="" class="view-courses-button"> View Courses</a>
