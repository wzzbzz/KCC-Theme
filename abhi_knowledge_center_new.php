<?php
/* Template Name: Abhi knowledge Center New */ 
 ?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= site_url;?>/wp-content/plugins/ultimate-member/assets/css/select2/select2.min.css">
