                        ...
                        <form class="form-horizontal" method="POST" action="addEvent.php">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="title" class="col-sm-2 control-label">Name of Event:</label>
                                    <div class="col-sm-10">
                                        <!-- <input type="text" name="title" class="form-control" id="title" placeholder="Activity" autocomplete="off" style="height: 80px;" required=""> -->
                                        <textarea rows="4" cols="1" id="title" class="form-control" name="title" maxlength="100" value="" required></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <!-- <input type="text" name="title" class="form-control" id="title" placeholder="Activity" autocomplete="off" style="height: 80px;" required=""> -->
                                        <textarea rows="4" cols="1" id="organization" class="form-control" name="organization" maxlength="100" value="" required></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <!-- <input type="text" name="title" class="form-control" id="title" placeholder="Activity" autocomplete="off" style="height: 80px;" required=""> -->
                                        <textarea rows="4" cols="1" id="location" class="form-control" name="location" maxlength="100" value="" required></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="title" class="col-sm-2 control-label">Details:</label>
                                    <div class="col-sm-10">
                                        <!-- <input type="text" name="title" class="form-control" id="title" placeholder="Activity" autocomplete="off" style="height: 80px;" required=""> -->
                                        <textarea rows="4" cols="1" id="details" class="form-control" name="details" maxlength="100" value="" required></textarea>
                                    </div>
                                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <textarea rows="4" cols="10" id="title" class="form-control" name="title" maxlength="300" value="" ></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="title" class="col-sm-2 control-label">Organization:</label>
                            <div class="col-sm-10">
                                <!-- <input type="text" name="title" class="form-control" id="title" placeholder="Activity" autocomplete="off" style="height: 80px;" required=""> -->
                                <textarea rows="4" cols="1" id="organization" class="form-control" name="organization" maxlength="100" value="" ></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="title" class="col-sm-2 control-label">Location:</label>
                            <div class="col-sm-10">
                                <!-- <input type="text" name="title" class="form-control" id="title" placeholder="Activity" autocomplete="off" style="height: 80px;" required=""> -->
                                <textarea rows="4" cols="1" id="location" class="form-control" name="location" maxlength="100" value="" ></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="title" class="col-sm-2 control-label">Details:</label>
                            <div class="col-sm-10">
                                <!-- <input type="text" name="title" class="form-control" id="title" placeholder="Activity" autocomplete="off" style="height: 80px;" required=""> -->
                                <textarea rows="4" cols="1" id="details" class="form-control" name="details" maxlength="100" value="" ></textarea>
                            </div>
                        </div>
