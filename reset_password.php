...
<section class="login-header-page">
    <div class="container-fluid">
        <div class="images" style="background: url('https://knowledge.communication.worldcares.org/wp-content/uploads/2022/12/Group-78157-2-1.png');">
        ...
        <div class="row mt-lg-5 mt-2 pt-lg-4 pt-2">
            ...
            <div class="col-md-12 col-lg-6 d-lg-flex justify-content-lg-end"> 
                <div class="footer-links">
                    <ul>
                        <li><a href="https://knowledge.communication.worldcares.org//terms-of-use/" title="Terms of Use">Terms of Use</a></li>
                        <li>|</li>
                        <li><a href="https://knowledge.communication.worldcares.org//privacy-policy/" title="Privacy Policy">Privacy Policy</a></li>
                        <li>|</li>
                        <li><a href="https://knowledge.communication.worldcares.org/sitemap" title="Sitemap">Sitemap</a></li>
