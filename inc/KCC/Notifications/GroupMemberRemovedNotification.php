...
class GroupMemberRemovedNotification extends Notification
{
    ...
    public function __construct($args)
    {
        ...
        $this->subject = "Group Removal Notification";
    }

    public function send_email($recipient)
    {
        $this->subject = "You've been removed from a group";
    ...
    public function send_notification( $recipient )
    {
        ...
        $this->body = sprintf("You have been removed from  <strong>%s.</strong>", $this->group->name());
