                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-12">
                                            <div class="form-floating mb-3">
                                                ...
                                                <label for="floatingInput">Document title66</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-12">
                                            <div class="mb-3">
                                                   <select class="form-control js-example-basic-multiple77" name="tabs[]" >
                                                        <option value='COVID -19'>COVID -19</option>
                                                        <option value='Report Update'>Report Update</option>
                                                        <option value='Map'>Map</option>
                                                        <option value='Guidance Document'>Guidance Document</option>
                                                        <option value='Media Alert'>Media Alert</option>
                                                        <option value='Evacuation Update'>Evacuation Update</option>
                                                        <option value='Shelter in Place Update'>Shelter in Place Update</option>
                                                        <option value='Fire Update'>Fire Update</option>
                                                        <option value='Eruption Update'>Eruption Update</option>
                                                        <option value='Flooding Update'>COVIFlooding Update</option>
                                                        <option value='Weather Update'>Weather Update</option>
                                                     <option value='FEMA Alert'>FEMA Alert</option>
