...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= get_template_directory();?>/assets/css/style_new.min.css"/>
                ...
                <div class="groups_tabs">
                    <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <div class="custom-card d-flex align-items-center justify-content-center">
                                            <div class="close-group">
                                                <div class="text-center">
                                                    <img src ="<?php echo get_avatar_url($value->invited_from); ?>">
                                                </div>
                                                        ...
                                                        <div class="">
                                                            <form method="POST">
                                                                 ...
                                                                 <input type="hidden" name="reportsforms_nonce" value="<?php echo wp_create_nonce('reportsforms_nonce'); ?>" />
                                                                  <input type="hidden" name ="cancelMemberRequest" value="cancelMemberRequest">
                        ...
                        <div class="tab-pane fade" id="pills-Request" role="tabpanel" aria-labelledby="pills-home-tab">                        
                                ...
                                <?php
                                //$result = $wpdb->get_results("SELECT * FROM group_invite WHERE `group_id` = $groupId  AND  (`invited_from` = '".$current_user_id."' OR invited_to =  '".$current_user_id."') AND `status` = 'rejected'");
            ...
            <div class="row m-0">
               <div class="col-md-12">
                  <div class="d-flex justify-content-center">
                     <div>
                        <div>
                           <img src="<?= get_template_directory();?>/avatar.png" alt="Abhishek Rajput" height="150" title="" width="150" class="rounded-circle userImg">
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-md-12">
                  <div class="row d-flex justify-content-center ml-0 mr-0 mt-3">
                     <div class=" col-md-10">
                        <div class="d-flex justify-content-between">
                           <div class="text-center">
                              <img src="<?= get_template_directory();?>/assets/images/cdvc_1.png" class="img-fluid" alt="image">  
                              <p>CDVC Level 1</p>
                           </div>
                           <div class="text-center">
                              <img src="<?= get_template_directory();?>/assets/images/cdvc_2.png" class="img-fluid" alt="image">
                              <p>CDVC Level 2</p>
                           </div>
                           <div class="text-center">
                              <img src="<?= get_template_directory();?>/assets/images/cdvc_3.png" class="img-fluid" alt="image">
                              <p>CDVC Level 3</p>
                           </div>
                        </div>
                     </div>
