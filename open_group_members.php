<?php 
/* Template Name: Open Group Members */ 
 global $wpdb;  
...
<head>
    ...
    <title> Open Group Members</title>
    <!-- Favicon -->    
                ...
                <div class="groups_tabs">
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade active show" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">                        
                                ...
                                <?php
                                $result = $wpdb->get_results("SELECT * FROM group_invite WHERE `group_id` = $groupId   AND `status` = 'pending'");
                                if(!empty($result))
                                        ...
                                        <div class="custom-card d-flex align-items-center justify-content-center">
                                            <div class="close-group">
                                                ...
                                                <div class="text-center mt-3">
                                                    ...
                                                    <p><small>Invited on <?php echo date("m-d-Y", strtotime($value->created_at))?></small></p>
                                                </div>
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        <div class="">
                                                            <form method="POST">
                                                                 ...
                                                                 <input type ="hidden" name ="invited_from" value ="<?///php echo $value->invited_to ?>">
