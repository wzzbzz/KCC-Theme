<?php 
/* Template Name: Closed Group Members */ 
 global $wpdb; 
 ...
 $group = new \KCC\Group($_GET['group_id']);
                    ...
                    <div class="d-flex align-items-center justify-content-between grp_box">
                        <div class="g_group_box_new">
                            <ul class="nav nav-pills mb-3 linked_blog" id="pills-tab" role="tablist">
                                ...
                                <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">All Invited </a>
                                </li>
                                <li class="nav-item group_btn">
                ...
                <div class="groups_tabs">
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="pills-Request" role="tabpanel" aria-labelledby="pills-home-tab">                        
                                ...
                                <?php
                                $result = $wpdb->get_results("SELECT * FROM group_invite WHERE `group_id` = $groupId  AND `invited_to` = $current_user_id  AND `status` = 'rejected'");
