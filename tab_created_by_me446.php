                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div class="tab-content w-100">
                            <div class="col-xl-12 d-flex align-items-center justify-content-between flex-wrap px-0 mb-0">
                                <h5>All Resources By Me</h5>
                                <div class="btn_list_blog btn_short_list my-lg-4 mr-lg-4">
                                    <button class="btn_short_list" type="button" data-toggle="modal" data-target="#myModal"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/group_icon.png" class="img-fluid mr-2">Sort-995</button>
                                </div>
                            </div>
