...
.dropdown.right_dropdown button.dropdown-toggle{background:transparent;}
.top_title h5 {
    font-size: 27px;
}
.top_center_main {
...
.dropdown.right_dropdown .dropdown-toggle img {margin-right:3px;}
.dropdown-item {background:none;}
.dropdown-item a{color:#F92903;}
</style>
